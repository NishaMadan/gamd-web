				...
				if (!usi_app.suppress_page) {
					...
					if(usi_app.is_checkout_page) {
						...
						if (labels.length) {
							...
							if(suppress) {
								usi_commons.log('[usi] Suppressing due to premium content in cart')
								return;
							}
						}
					}
					...
					if(usi_app.is_cart_page) {
						...
						if(license_buttons) {
							...
							if(usi_app.is_suppressed) {
								usi_commons.log('[usi] Suppressing due to enhanced license in cart')
								return
							}
						}
					}
					...
					if (usi_date.is_between('2024-11-29T00:01:00-08:00', '2024-12-02T23:59:00-08:00')) {
